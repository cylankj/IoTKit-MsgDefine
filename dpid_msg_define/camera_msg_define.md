...
|  value定义 |  类型|   描述 | 
|---|---|---|
|begin_time|int| 开始时间点，距离零点的秒数，单位秒。按位标识，低八位标识分钟，次低八位标识小时。示例：00:00, 该值为0|
|end_time|int| 结束时间点，距离零点的秒数，单位秒。按位标识，低八位标识分钟，次低八位标识小时。示例：23:59, 二进制为 0b00010111 00111011，该值为5947|
