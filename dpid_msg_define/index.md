...
| [DPIDBaseSDInfo = 222](base_msg_define.md#dpidbasesdinfo--222)                  | 是否插入SD卡及错误的信息                      | 是        | bool       | 是        | 显示         | 无              |无            | 否           | 是 |
...
| [DPIDCameraHangMode = 509](camera_msg_define.md#dpidcamerahangmode--509)                | 视频模式 (壁挂或吊顶)  | 是    | int        | 是        | 控制         | 有        |无                | 是 | 否 |
