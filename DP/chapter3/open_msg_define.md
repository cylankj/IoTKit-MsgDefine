...
|---|---|---|
|id| int | 开放功能唯一标识 |
|...| ... | 可变参数，如原id不能满足查询条件，通过此字段扩展，具体参数定义参考消息定义  |
...
响应：
{20201, "", "", seq, [[{4, time, "{"sdcard_errno":0}"}], [{1, time, "{"ssid":"cylan_605"}"}]]}
...
如查询报警消息的响应：
{20201, "", "", seq, [[{5，time, "{"file":7,"type":1}"},{5, time,{"file":7,"type":1}}]]}
...
如查询报警消息的响应：
{20209, "", "", seq, [{5，time, "{"file":7,"type":1}"},{1, time, "{"ssid":"cylan_605"}"}]}
